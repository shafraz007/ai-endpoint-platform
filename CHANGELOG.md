...
All notable changes to the Armada Platform will be documented in this file.
...
**First production release of Armada Platform with parent-child MCP-like architecture.**
